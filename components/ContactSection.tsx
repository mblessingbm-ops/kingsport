    ...
    return (
        <section id="contact" className="py-12 bg-slate-50">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 h-[500px]">
                ...
                <div className="bg-slate-900 text-white p-8 md:p-12 rounded-2xl flex flex-col justify-center h-full shadow-xl">
                    <div className="mb-8">
                        <h3 className="text-3xl font-black uppercase text-white mb-2">Get in Touch</h3>
                        <p className="text-slate-400">Speak to our sales team directly.</p>
                    </div>

                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            <Phone className="w-6 h-6 text-oxblood-400 shrink-0 mt-1" />
                        ...
                        <div className="flex items-start gap-4 pt-6 border-t border-slate-800">
                            <MapPin className="w-6 h-6 text-oxblood-400 shrink-0 mt-1" />
                            <div>
