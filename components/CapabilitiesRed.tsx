...
export default function CapabilitiesRed() {
    ...
    const caps = [
        ...
        { name: 'Embroidery', desc: 'High-density stitching for a premium, long-lasting corporate look.', icon: Tangent },
        ...
        <section className="py-24 bg-zinc-900 text-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex justify-between items-end mb-12">
                    <h2 className="text-3xl md:text-5xl font-black uppercase border-l-8 border-oxblood-600 pl-6 leading-none">
                        Our <br />
                        <span className="text-oxblood-600">Capabilities</span>
                    </h2>
                    <div className="flex gap-2">
                        <button
                            onClick={() => emblaApi?.scrollPrev()}
                            disabled={!canScrollPrev}
                            className="p-3 border border-zinc-700 hover:bg-oxblood-600 hover:text-white hover:border-oxblood-600 transition-colors disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-white"
                        >
                            ←
                        </button>
                        <button
                    ...
                    <div className="flex gap-6">
                        {caps.map((item, idx) => (
                            <div key={idx} className="flex-[0_0_85%] md:flex-[0_0_350px] min-w-0">
                                <div className="h-full border border-zinc-800 bg-zinc-900/50 p-8 hover:border-oxblood-600/50 group transition-colors">
                                    <div className="mb-6 text-oxblood-600 opacity-80 group-hover:opacity-100 transition-opacity">
